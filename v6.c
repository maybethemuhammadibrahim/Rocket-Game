...
void game(){
    ...
    // mciSendString("open \"gameover1.mp3\" type mpegvideo alias over1", NULL, 0, NULL);
    // mciSendString("play over1", NULL, 0, NULL);
    // Sleep(500);
    // mciSendString("stop over1", NULL, 0, NULL);
    // mciSendString("close over1", NULL, 0, NULL);
